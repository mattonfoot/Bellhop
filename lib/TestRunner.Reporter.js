(function(context) {
  ...
  context.Reporter = Reporter;
	...
	function attachToFramework() {
		if ( context.QUnit ) {
			return attachToQUnit();
		}

		if ( context.jasmine ) {
			return attachToJasmine();
		}

		context.setTimeout(attachToFramework, 0);
	}
