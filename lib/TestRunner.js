...
(function(Global, undefined) {
	...
	var consoleReporter = './TestRunner.Reporter.js';
	...
	Global.TestRunner.prototype = {
		...
		run: function(runner) {
			...
			fixture.onInitialized = function() {
	...
	function getFixtureResults(fixture) {
		return fixture.evaluate(function() {
			return {
				modules: Reporter.results.modules,
				failed: Reporter.results.failed,
				passed: Reporter.results.passed,
				total: Reporter.results.total,
				runtime: Reporter.results.runtime
			};
		});
	};
