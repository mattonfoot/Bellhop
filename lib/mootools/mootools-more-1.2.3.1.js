...
var doubleSlider = new Class({
	...
	setMin: function(stepMin){
		...
		this.bkg.style.clip = "rect(0px "+  (parseInt(this.toPosition(this.step)) +3) + "px 13px 0px, 10)";
		status =this.bkg.style.clip + "  vl= " + parseInt(this.toPosition(this.step), 10) ; //Debug
	...
	setMax: function(stepMax){
		...
		var r = parseInt(this.clip_l + w, 10); 
		this.bkg.style.clip = "rect(0px "+  r + "px 13px "+ this.clip_l + "px)";
		...
		if(this.options.isinit){
			...
			mx= parseInt(this.maxknob.getStyle('left'), 10) - this.options.offset-4 ;
			lim[this.z] = [mi, mx];
	...
	checkStep: function(mx){
		...
		if(this.maxknob!=null) {
			...
			mi = parseInt(this.knob.getStyle('left'), 10)-this.options.offset+22; 
			...
			this.clip_l = parseInt(this.knob.getStyle('left'), 10) + 10;
			//var w = Math.abs(parseInt(this.knob.getStyle('left')) - parseInt(this.maxknob.getStyle('left'))) + 3;	
			var w = Math.abs(parseInt(this.knob.getStyle('left')) - parseInt(this.maxknob.getStyle('left')), 10, 10);
			//if(w > 3) w = w+3;
			...
			//this.bkg.style.clip = "rect(0px "+  (parseInt(this.drag.value.now[this.z]) +3)  + "px 13px 0px)"  
